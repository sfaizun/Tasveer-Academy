...
export default function ScheduleView({ rows }: { rows: ScheduleRow[] }) {
  ...
  return (
    <>
      {/* overflow:visible overrides .panel's usual overflow:hidden (which exists to clip
          rounded corners on things like tables) — this panel only holds the filter bar, and
          the subject checklist dropdown below is absolutely positioned and needs to be able
          to spill outside the panel's own box instead of being clipped at its bottom edge. */}
      <div className="panel no-print" style={{ overflow: "visible" }}>
